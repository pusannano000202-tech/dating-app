...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        boot: {
          canvas: 'rgb(var(--boot-canvas-rgb, 248 243 236) / <alpha-value>)',
          surface: 'rgb(var(--boot-surface-rgb, 255 253 248) / <alpha-value>)',
          soft: 'rgb(var(--boot-soft-rgb, 245 238 231) / <alpha-value>)',
          primary: 'rgb(var(--boot-primary-rgb, 255 79 95) / <alpha-value>)',
          coral: 'rgb(var(--boot-coral-rgb, 255 117 72) / <alpha-value>)',
          amber: 'rgb(var(--boot-amber-rgb, 255 176 106) / <alpha-value>)',
          ink: 'rgb(var(--boot-ink-rgb, 23 20 18) / <alpha-value>)',
          body: 'rgb(var(--boot-body-rgb, 75 67 61) / <alpha-value>)',
          muted: 'rgb(var(--boot-muted-rgb, 138 129 120) / <alpha-value>)',
          hairline: 'rgb(var(--boot-hairline-rgb, 232 222 212) / <alpha-value>)',
          mint: 'rgb(var(--boot-mint-rgb, 223 248 236) / <alpha-value>)',
          sky: 'rgb(var(--boot-sky-rgb, 234 245 255) / <alpha-value>)',
          lavender: 'rgb(var(--boot-lavender-rgb, 240 234 255) / <alpha-value>)',
        },
        destiny: {
          base:       '#060612',
          violet:     '#7C3AED',
