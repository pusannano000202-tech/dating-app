...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        boot: {
          canvas: 'rgb(var(--boot-canvas-rgb) / <alpha-value>)',
          surface: 'rgb(var(--boot-surface-rgb) / <alpha-value>)',
          soft: 'rgb(var(--boot-soft-rgb) / <alpha-value>)',
          primary: 'rgb(var(--boot-primary-rgb) / <alpha-value>)',
          'primary-dark': 'rgb(var(--boot-primary-dark-rgb) / <alpha-value>)',
          coral: 'rgb(var(--boot-coral-rgb) / <alpha-value>)',
          amber: 'rgb(var(--boot-amber-rgb) / <alpha-value>)',
          info: 'rgb(var(--boot-info-rgb) / <alpha-value>)',
          'info-soft': 'rgb(var(--boot-info-soft-rgb) / <alpha-value>)',
          ink: 'rgb(var(--boot-ink-rgb) / <alpha-value>)',
          body: 'rgb(var(--boot-body-rgb) / <alpha-value>)',
          muted: 'rgb(var(--boot-muted-rgb) / <alpha-value>)',
          hairline: 'rgb(var(--boot-hairline-rgb) / <alpha-value>)',
          mint: '#FCECE6',
          sky: '#EAF5FF',
          lavender: '#F0EAFF',
        },
