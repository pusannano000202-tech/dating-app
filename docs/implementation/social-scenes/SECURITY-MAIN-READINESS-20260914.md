...
> 후속 구현: 세 금융 BLOCK 항목의 로컬 보완·검증과 남은 운영 조건은 [SECURITY-REMEDIATION-20260914.md](./SECURITY-REMEDIATION-20260914.md)를 따른다. 아래 내용은 `8b90e9ae` 체크포인트 당시의 검토 기록으로 보존한다.
