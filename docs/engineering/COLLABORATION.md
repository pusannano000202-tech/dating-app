...
2026-09-20 사용자가 성준은 업장/관리자, 본 작업은 사용자 앱으로 분업을 지정했다. 이번 두 브랜치의 파일 담당·공용 API/DB 변경 절차·공유 방법은 [사용자·업장 인수인계](../handoff/active/QUANTUM_USER_PARTNER_HANDOFF_2026-09-20.md)가 추가 기준이다. 과거 2인 자동 push 규칙을 복원한 것은 아니다.
