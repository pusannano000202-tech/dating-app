CREATE OR REPLACE FUNCTION public.get_my_pre_match_card_draft()
RETURNS TABLE (
  user_id UUID,
  content_text TEXT,
...
REVOKE ALL ON TABLE public.pre_match_card_drafts FROM PUBLIC, anon, authenticated;

REVOKE ALL ON FUNCTION public.get_my_pre_match_card_draft()
  FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.save_my_pre_match_card_draft(TEXT, SMALLINT)
  FROM PUBLIC, anon, authenticated, service_role;

GRANT EXECUTE ON FUNCTION public.get_my_pre_match_card_draft() TO authenticated;
