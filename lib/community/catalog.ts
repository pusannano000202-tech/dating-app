...
export const featuredMeetupIdeas: FeaturedMeetupIdea[] = [
  ...
  },
  {
    ...
    label: '커피 한 잔부터 편하게',
    title: '학교 앞 카페 한 시간',
    description: '따뜻한 카페에서 디저트를 나누며 가볍게 이야기하는 모임',
    imageSrc: '/images/meetups/meetup-cafe-friends-v1.webp',
    imageAlt: '학교 앞 따뜻한 카페에서 커피와 디저트를 두고 이야기하는 대학생 네 명',
  },
  {
    id: 'campus-small-shop',
    category: 'other',
    label: '취향을 발견하는 산책',
    title: '문구·소품숍 같이 구경',
    description: '학교 근처 작은 가게를 천천히 둘러보며 서로의 취향을 나눠요.',
    imageSrc: '/images/meetups/meetup-small-shop-v1.webp',
    imageAlt: '학교 근처 문구와 소품 가게에서 노트를 함께 구경하는 대학생 네 명',
  },
  {
    id: 'evening-neighborhood-walk',
    category: 'walking',
    label: '말이 자연스럽게 이어져요',
    title: '저녁 동네 산책',
    description: '익숙한 학교 주변을 함께 걸으며 부담 없이 이야기를 시작해요.',
    imageSrc: '/images/match/events/event-walk-v2.webp',
    imageAlt: '저녁 산책길을 나란히 걸으며 이야기하는 대학생들',
  },
  {
    id: 'evening-dining',
    category: 'dining',
