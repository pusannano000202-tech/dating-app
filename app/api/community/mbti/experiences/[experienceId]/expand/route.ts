import { parseExperienceId, parseMutationInput, readMbtiJson } from '@/lib/community/mbti/input'
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    return mbtiPrivateJson({ result: await repository.expandExperience(experienceId, input) })
  } catch (error) {
