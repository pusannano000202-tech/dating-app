...
const MAX_EVIDENCE_MULTIPART_BYTES = MEETING_EVIDENCE_MAX_BYTES + MULTIPART_OVERHEAD_BYTES
...
export async function POST(request: Request, props: { params: Promise<{ id: string }> }) {
  ...
  let form: FormData
  try {
    form = await readBoundedMultipartFormData(request, MAX_EVIDENCE_MULTIPART_BYTES)
  } catch (error) {
