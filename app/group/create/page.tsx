          ...
          <>
            ...
            {inQueue ? (
              ...
              <>
                ...
                <Link href="/community/department" className="mb-4 block rounded-xl border border-boot-hairline bg-white p-4 text-sm font-bold text-boot-body">
                  같은 학과 사람들과는 학과 모집에서 만나요
                  <span className="mt-1 block text-xs font-normal">자동 친구 추가 없이, 원하는 활동에 직접 참여할 수 있어요.</span>
                </Link>
