...
export function GroupMemberStatusPanel({
  ...
  return (
    ...
    >
      ...
      <p className="mt-5 mb-2 text-xs font-bold text-boot-muted">그룹 멤버</p>
      <div className="grid grid-cols-3 gap-2">
        {members.map((member) => {
          ...
          return (
            ...
            >
              <div className="mx-auto mb-2 h-8 w-8 rounded-full bg-boot-soft flex items-center justify-center">
        ...
        {Array.from({ length: openSlots }).map((_, index) => (
          <div
            key={`open-${index}`}
            className="min-h-[86px] rounded-2xl border border-dashed border-boot-hairline bg-white/70 px-2 py-3 text-center flex flex-col items-center justify-center"
          >
