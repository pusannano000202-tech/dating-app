...
import { createManualStudyCourse, getDepartmentCourseSuggestions, getDepartmentStudyCoverage, getStudyCatalogCoverage, getStudyCourse, getStudyCoursePhoto, searchStudyCourses, type StudyCourse } from '@/lib/meetups/study-catalog'
...
export default function DepartmentCourseDiscovery({ demo = false }: { demo?: boolean }) {
  ...
  function selectDepartment(value: string) {
    ...
    setDepartmentQuery('')
    if (!getDepartmentStudyCoverage(value)) openSearch()
