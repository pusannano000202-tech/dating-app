...
test('profile photo replacement recomputes canonical completion and invalidates any old appearance score server-side', () => {
  ...
  assert.match(route, /refresh_profile_onboarding_completion/)
  assert.doesNotMatch(route, /is_profile_complete:\s*true/)
