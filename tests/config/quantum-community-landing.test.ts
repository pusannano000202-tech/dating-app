...
test('community photo explorer gives each topic truthful copy and one destination', () => {
  ...
  assert.doesNotMatch(source, /social-scenes\/delivery\.png/)
...
test('Campus Eats spotlight exposes all seven brackets and never merges the two coffee zones', () => {
  ...
  assert.match(spotlight, /mode=map&category=donkatsu&list=open/)
  assert.match(spotlight, /mode=map&category=pizza&list=open/)
  assert.match(spotlight, /mode=map&category=chicken&list=open/)
  assert.match(spotlight, /mode=map&category=coffee-main&list=open/)
  assert.match(spotlight, /mode=map&category=coffee-north&list=open/)
  assert.match(spotlight, /mode=map&category=gukbap&list=open/)
  assert.match(spotlight, /mode=map&category=milmyeon&list=open/)
